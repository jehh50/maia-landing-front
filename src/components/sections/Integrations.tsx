...
const integrations = [
  'WhatsApp', 'HubSpot', 'VTEX', 'SAP', 'Slack', 'Telegram', 'Microsoft Teams', 'Discord',
  'Salesforce', 'Notion', 'Google Workspace', 'Microsoft 365',
  'Zapier', 'Stripe', 'Shopify', 'Webhooks', 'WooCommerce'
];
    ...
    <Box component="section" id="integrations" sx={{ py: { xs: 7, md: 10 }, background: 'linear-gradient(180deg, var(--bg-soft) 0%, #FFFFFF 30%, #FFFFFF 70%, var(--bg-soft) 100%)' }}>
      <Container>
        <Box className="reveal" sx={{ textAlign: 'center', maxWidth: 680, mx: 'auto', mb: 6 }}>
          <Typography variant="overline" color="primary" fontWeight={600}>Integraciones</Typography>
          <Typography variant="h2" sx={{ fontSize: { xs: '1.7rem', md: '2.4rem' }, mt: 1, mb: 2 }}>
            Conecta lo que ya usas
          </Typography>
          <Typography color="text.secondary">+50 integraciones nativas. ¿No ves la tuya? Webhooks y API REST.</Typography>
        </Box>
