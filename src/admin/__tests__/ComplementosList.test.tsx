...
import type { AdminComplemento, AdminUser } from '../../lib/api';
...
/**
 * Backend mínimo de `/api/complementos` + `/api/admin/complementos` sobre
 * `globalThis.fetch` con `Response` reales: **no se mockea `src/lib/api.ts`**.
 *
 * Reproduce dos comportamientos del contrato real:
 *
